    ...
    <div>
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-1">
          <a href="https://github.com/VikramChennai/YCGYM" target="_blank" rel="noopener noreferrer">
      ...
      <section className="flex flex-col items-center justify-center px-4 py-16 text-center sm:py-24">
        ...
        <p className="mt-4 max-w-lg text-lg text-muted-foreground">
          YCGYM is an Open Source community tool that lets you book shared gym sessions with other YC founders
        </p>
